...
public sealed partial class RMCCVars : CVars
{
    ...
    public static readonly CVarDef<int> RMCPlaytimeEmeraldMedalTimeHours =
        CVarDef.Create("rmc.playtime_emerald_medal_time_hours", 200, CVar.REPLICATED | CVar.SERVER); // RuMC edit

    public static readonly CVarDef<int> RMCPlaytimePrismaticMedalTimeHours =
        CVarDef.Create("rmc.playtime_prismatic_medal_time_hours", 500, CVar.REPLICATED | CVar.SERVER); // RuMC edit
